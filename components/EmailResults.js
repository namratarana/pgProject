          ...
          >
            ...
            <div className='emailContent'>
              ...
              <div className="d-flex justify-content-left  w-100">
                  <svg className="emailIcon  ms-2" width="50" height="50" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div> 
                    <p className="card2subText text-start ms-2">Your email address</p>
