...
const emailResults = ({
  ...
  return (
    <div className=' mt-1'>
          ...
          >
            ...
            <div className='emailContent'>
              ...
              <div className="d-flex justify-content-left  w-100">
                  ...
                  <div> 
                    <p className="card2subText-small text-start ">Your email address</p>
                                              
                    <input
                      name='email'
                      type='text'
                      className='emailInput-small '
                      value={emailAddress}
                ...
                <div className='form-check'>
                  <div className="d-flex justify-content-center">
                      <input
                          ...
                          className='emailResultsButton-small d-flex justify-content-center mt-3 event_button_click'
                          type='submit'
                  ...
                  <div className="d-flex justify-content-center  ms-2">
                      <label className='form-check-label-small checkBoxLabel-small mt-4'>
      ...
      <div
        className={`submittedButtonContainer-small d-flex align-items-center w-100 ${!emailSubmitted && 'd-none'}`}
      >
        <input
          disabled={true}
          className='mt-3 emailResultsButton-small emailButton1-small'
          type='submit'
